...
(function (factory) {
  ...
  // Browser
    ...
    var PageableCollection = factory(_, Backbone, window.Application || Backbone);
  ...
  Application = Application || Backbone;

  var BBColProto = Application.Collection.prototype;
  ...
  */
  var PageableCollection = Backbone.PageableCollection = Application.Collection.extend({
    ...
    */
    _makeFullCollection: function (models, options) {
      ...
      var fullCollection = new (Application.Collection.extend(proto))(models, options);
